...
def trainNN(attempt, initial_learning_rate, weight_decay):
	...
	checkpoint_callback = ModelCheckpoint(filepath=f'../../models/ResNetLikeCNNx3/best_attempt{attempt}.h5', 
	...
	with open(f'../../models/ResNetLikeCNNx3/history_attempt{attempt}.csv', 'w') as f:
...
def trainLogReg(attempt):
	...
	NNmodel = keras.models.load_model(f'../../models/ResNetLikeCNNx3/best_attempt{attempt}.h5', custom_objects=custom_objects)
	...
	with open(f'../../models/ResNetLikeCNNx3/logreg_attempt{attempt}.pkl', 'wb') as file:
...
def testF1(attempt):
	custom_objects = { "CustomAdamW": CustomAdamW, "CustomLearningRateSchedule": CustomLearningRateSchedule }
	model = keras.models.load_model(f'../../models/ResNetLikeCNNx3/best_attempt{attempt}.h5', custom_objects=custom_objects)
	...
	with open(f'../../models/ResNetLikeCNNx3/logreg_attempt{attempt}.pkl', 'rb') as file:
