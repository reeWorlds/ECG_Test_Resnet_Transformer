...
def getScedule(initial_learning_rate, datasetLen, minibatch, epochN, num_waves = 4, warmup_epochs = 4):
...
def plot_lr_schedule(path):
	total_steps = (68062 + 128 - 1) // 128 * 132
	lr_schedule = getScedule(1e-3, 68062, 128, 132)
...
class CustomLearningRateSchedule(tf.keras.optimizers.schedules.LearningRateSchedule):
	def __init__(self, initial_learning_rate, datasetLen, minibatch, epochN, num_waves=4, warmup_epochs=4):
...
def trainNN(attempt, initial_learning_rate, weight_decay):
	...
	checkpoint_callback = ModelCheckpoint(filepath=f'../../models/ResNetLikeCNNx4/best_attempt{attempt}.h5', 
	...
	with open(f'../../models/ResNetLikeCNNx4/history_attempt{attempt}.csv', 'w') as f:
...
def trainLogReg(attempt):
	...
	NNmodel = keras.models.load_model(f'../../models/ResNetLikeCNNx4/best_attempt{attempt}.h5', custom_objects=custom_objects)
	...
	with open(f'../../models/ResNetLikeCNNx4/logreg_attempt{attempt}.pkl', 'wb') as file:
...
def testF1(attempt):
	custom_objects = { "CustomAdamW": CustomAdamW, "CustomLearningRateSchedule": CustomLearningRateSchedule }
	model = keras.models.load_model(f'../../models/ResNetLikeCNNx4/best_attempt{attempt}.h5', custom_objects=custom_objects)
	...
	with open(f'../../models/ResNetLikeCNNx4/logreg_attempt{attempt}.pkl', 'rb') as file:
...
def trainLogRegFull(listAttempts):
	...
	custom_objects = { "CustomAdamW": CustomAdamW, "CustomLearningRateSchedule": CustomLearningRateSchedule }
	NNmodels = [keras.models.load_model(f'../../models/ResNetLikeCNNx4/best_attempt{x}.h5', custom_objects=custom_objects) for x in listAttempts]
	...
	with open(f'../../models/ResNetLikeCNNx4/logreg_full.pkl', 'wb') as file:
		pickle.dump(logreg, file)
...
def testF1Full(listAttempts):
	...
	with open(f'../../models/ResNetLikeCNNx4/logreg_full.pkl', 'rb') as file:
		logreg = pickle.load(file)
...
if __name__ == "__main__":
	...
	#plot_lr_schedule("../../models/ResNetLikeCNNx4/schedule.png")
	
	#for attempt in range(1, 4):
	#	trainNN(attempt, 1e-3, 1e-1)
	#	plotTrainValidCurve(f"../../models/ResNetLikeCNNx4/history_attempt{attempt}.csv",
	#				 f"../../models/ResNetLikeCNNx4/history_attempt{attempt}.png")
